...
<main>
  ...
  <section id="domu">
    ...
    <div class="game-list">
      <div class="game-card">
        <img src="data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD... (zkráceno pro přehlednost)" alt="Cyberpunk" />
      ...
      <div class="game-card">
        <img src="data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD... (zkráceno pro přehlednost)" alt="Elden Ring" />
        <div class="game-content">
          <h3>Elden Ring</h3>
